namespace Models
{
	public class Carro
	{
        ...
        public Carro(string marca, string modelo)
        {
            ...
            Tanque = 5;
            Ligado = false;
            PneuDianteiroEsquerdo = new Pneu(10, "Pirelli");
            PneuDianteiroDireito = new Pneu(10, "Pirelli");
            PneuTrazeiroEsquerdo = new Pneu(10, "Pirelli");
            PneuTrazeiroDireito = new Pneu(10, "Pirelli");
        }
